...
class PsUrl {
  ...
  static const String ps_owner_relation_url = 'rest/items/get_owner_relation';

  static const String ps_search_item_url = 'rest/items/search';
  static const String ps_product_url = 'rest/items/search';

  static const String ps_explore_url = 'rest/items/get_recent_items';
  static const String ps_premium_url = 'rest/items/get_premium_items';
  static const String ps_popular_url = 'rest/items/get_popular_items';
  static const String ps_free_url    = 'rest/items/get_free_items';
  static const String ps_brands_url  = 'rest/items/get_brands_items';
  static const String ps_topLike_url = 'rest/items/get_toplike_items';

  static const String ps_nearest_url =
      'rest/items/get_nearest_items/api_key/${PsConfig.ps_api_key}';

  static const String ps_Prefcat_url =
      'rest/items/get_prefcat_items/api_key/${PsConfig.ps_api_key}';
  static const String ps_Prefcat_bulk_url =
      'rest/items/get_prefcat_items_bulk/api_key/${PsConfig.ps_api_key}';

  static const String ps_top_recom_url =
      'rest/items/get_recommended_items/api_key/${PsConfig.ps_api_key}';
  static const String ps_nearest_recom_url =
      'rest/items/get_recommended_items_nearest/api_key/${PsConfig.ps_api_key}';
  static const String ps_wishitems_recom_url =
      'rest/items/get_recommended_items_wishitems/api_key/${PsConfig.ps_api_key}';
  static const String ps_friends_recom_url =
      'rest/items/get_recommended_items_friends/api_key/${PsConfig.ps_api_key}';

  static const String ps_family_items_url =
      'rest/items/get_family_items';
  //static const String ps_family_network_items_url  = 'rest/items/get_family_network_items';
  static const String ps_family_network_items_url  = 'rest/items/get_network_items';
  static const String ps_friends_network_items_url = 'rest/items/get_friends_network_items';


  static const String ps_get_item_by_followUser_url =
  ...
  static const String ps_my_pending_item_url =
      'rest/items/get_my_pending_items/api_key/${PsConfig.ps_api_key}';

  static const String ps_reported_item_url =
      'rest/items/get_reported_item_by_loginuser';

  static const String ps_similar_by_tags_url = 'rest/items/get_similar_by_tags';

  static const String ps_entity_tags_save_url = 'rest/entity_tags/save';
  ...
  static const String ps_get_owner_subcat_subscribes_url =
      'rest/subcat_subscribes/get_owner_subcat_subscribes/api_key/${PsConfig.ps_api_key}';
  ...
  static const String ps_get_users_by_phone_url =
      'rest/Users/compare_phone_numbers/api_key/${PsConfig.ps_api_key}';

  static const String ps_blocked_user_url =
      'rest/users/get_blocked_user_by_loginuser';

  // ============================================================
  // 👥 RELATIONS (FOLLOW / BLOCK)
  // ============================================================
  ...
  static const String ps_is_follow_url = 'rest/userfollows/is_follow';
  ...
  static const String ps_notify_chat_url =
      'rest/chats/notify_chat/api_key/${PsConfig.ps_api_key}';
  ...
  static const String ps_Buyer_mark_as_sold_url =
      'rest/chats/buyer_item_sold_out/api_key/${PsConfig.ps_api_key}';

  static const String ps_Buyer_mark_Not_sold_url =
      'rest/chats/buyer_item_Not_sold_out/api_key/${PsConfig.ps_api_key}';

  static const String ps_get_success_swap_items_url =
      'rest/Chat_items/get_sucess_swap/api_key/${PsConfig.ps_api_key}';
  ...
  static const String ps_wishitem_image_upload_url =
      'rest/images/upload_wishitem/api_key/${PsConfig.ps_api_key}';
  ...
  // ============================================================
  // 🧠 META (TYPES / CONDITIONS / OPTIONS / CURRENCY)
  // ============================================================
  ...
  static const String ps_wish_item_entry_url =
      'rest/items_wishlist/add/api_key/${PsConfig.ps_api_key}';

  static const String ps_get_wishlist_items_url =
      'rest/items_wishlist/get_wishlist_items/api_key/${PsConfig.ps_api_key}';

  static const String ps_get_owner_wishlist_items_url =
      'rest/items_wishlist/get_user_wishlist/api_key/${PsConfig.ps_api_key}';



  // ============================================================
  // 💰 TAAPDEEL: SWAP BALANCE & POINTS
  // ============================================================

  static const String ps_swap_balance_increase_url =
      'rest/users/swap_balance_increase/api_key/${PsConfig.ps_api_key}';

  static const String ps_swap_balance_decrease_url =
      'rest/users/swap_balance_decrease/api_key/${PsConfig.ps_api_key}';

  static const String ps_swap_no_increase_url =
      'rest/users/swap_no_increase/api_key/${PsConfig.ps_api_key}';

  static const String ps_check_swap_balance_url =
      'rest/users/check_swap_balance/api_key/${PsConfig.ps_api_key}';

  static const String ps_points_increase10_url =
      'rest/users/points_increase10/api_key/${PsConfig.ps_api_key}';
}