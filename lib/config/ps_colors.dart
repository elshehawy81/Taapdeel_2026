...
class PsColors {
  ...
  /// Base surface color for many components.
  // ✅ FIX: التطبيق Light Mode فقط دايماً (_loadLightColors بتشتغل في الحالتين)،
  // فلازم القيمة الافتراضية وقت static init تبقى Light مش Dark، عشان أول
  // frame بييترسم (قبل ما PsColors.loadColor()/loadColor2() تتنفذ) يبان بلون
  // صح بدل اللون الداكن (#121A24) اللي كان بيسبب الشاشة السودا.
  static Color mainLightColorWithBlack = _l_base_color;
  ...
  static Color mainDividerColor = _l_divider_color;
  ...
  static Color baseColor = _l_base_color;
  static Color baseDarkColor = _l_base_dark_color;
  static Color baseLightColor = _l_base_light_color;
  ...
  static Color textPrimaryColor = _l_text_primary_color;
  static Color textPrimaryDarkColor = _l_text_primary_dark_color;
  static Color textPrimaryLightColor = _l_text_primary_light_color;
