...
ThemeData themeData(ThemeData_) {
...
// Normal text on white/light surfaces.
  ...
  final ColorScheme colorScheme = ColorScheme.light(
    ...
    onSurfaceVariant: PsColors.textPrimaryLightColor,
    outline: PsColors.secondary200,
    outlineVariant: PsColors.grey300,
  );
  ...
  return baseTheme.copyWith(
    ...
    disabledColor: PsColors.textPrimaryLightColor.withValues(alpha: 0.65),
    hintColor: PsColors.textPrimaryLightColor,
