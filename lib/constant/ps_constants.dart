///
/// Global static constants used across the app.
/// --------------------------------------------------
/// NOTE:
/// - Do NOT change string values (they are used by API / storage).
/// - If you want to improve or rename something later, use
///   `// Future Improvement:` comments to track it.
///
...
class PsConst {
  ...
  static const String VALUE_HOLDER__HAS_FAV_CATEGORIES = 'has_fav_categories';
  ...
  // --------------------------------------------------
  // App Info / Versioning / Force Update
  // --------------------------------------------------
  ...
  // --------------------------------------------------
  // NOTE: Most of these are used as API query keys, do not change values.
  ...
  static const String FILTERING_FAVOURITE = 'favourite_count';
  ...
  // Future Improvement: There is duplication between FILTERING__TRENDING and
  // FILTERING_TRENDING. Consider unifying usages in the codebase later.

  // --------------------------------------------------
  // Generic Flags / Common String Values
  // --------------------------------------------------
  ...
  // Future Improvement: Add platform detection if iOS/web support is extended.
  ...
  // Discount / Featured flags (string-based)
  static const String IS_DISCOUNT = '1';
  static const String IS_FEATURED = '1';

  // --------------------------------------------------
  // Chat Type / Direction (String flags)
  // --------------------------------------------------
  ...
  // --------------------------------------------------
  // Value Holder Keys (User / Session / App State)
  // --------------------------------------------------
  // These are keys used in SharedPreferences (ValueHolder).
  ...
  static const String VALUE_HOLDER__USER_NAME_TO_VERIFY =
      'USER_NAME_TO_VERIFY';
  ...
  // Date range values (generic usage)
  ...
  // Default currency / payments
  static const String VALUE_HOLDER__DEFAULT_CURRENCY = 'DEFAULT_CURRENCY';
  static const String VALUE_HOLDER__DEFAULT_CURRENCY_ID =
      'DEFAULT_CURRENCY_ID';
  ...
  static const String VALUE_HOLDER__DETAIL_OPEN_COUNTER =
      'DETAIL_OPEN_COUNTER';

  static const String CALL_BACK_EDIT_TO_PROFILE = 'CALL_BACK_EDIT_TO_PROFILE';

  // --------------------------------------------------
  // Value Holder keys for Item Draft (Add/Edit Item)
  // --------------------------------------------------
  ...
  static const String VALUE_HOLDER__USER_ALREADY_CHOOSE =
      'USER_ALREADY_CHOOSE';
  ...
  // Future Improvement: Typo in USER_DELECTED (should be USER_DELETED), keep
  // as-is for compatibility and wrap with helper methods if needed later.

  // --------------------------------------------------
  // Map / Location visualization constants
  // --------------------------------------------------
  ...
  // --------------------------------------------------
  // Menu Request Codes (Legacy Android-style navigation codes)
  // --------------------------------------------------
  ...
  static const int CHAT_TYPE_OTHER = 6;

  // Future Improvement: CHAT_TYPE_ACCEPT and CHAT_TYPE_REJECT are both 0.
  // This is likely a bug or legacy constant. Before changing, search usages
  // and add a proper mapping layer.
  ...
  // Payment on/off flags (string "1" = enabled)

  static const String OFFLINE_PAYMENT_ENABLE = '1';

  // --------------------------------------------------
  // Hero Tags (for Hero animations)
  // --------------------------------------------------
  ...
  // Future Improvement: Do not hardcode default credentials. Move to secure
  // config or remove entirely in production.

  // --------------------------------------------------
  // Aspect Ratio values (string keys used in config)
  // --------------------------------------------------
  ...
  static const String REQUEST_PENDING = '1';
  static const String REQUEST_ACCEPTED = '2';
  static const String REQUEST_SWAPPED = '3';
  static const String REQUEST_REJECTED = '4';
}
