class RoutePaths {
  ...
  // --------------------------------------------------
  // Notifications / blocking / reporting / offers
  // --------------------------------------------------
  ...
  static const String notiSetting = '/notiSetting'; // legacy alias — keep
  ...
  static const String profile_container_legacy = '/profile_container_legacy';
  static const String editProfile = '/editProfile';

  // --------------------------------------------------
  // Product search / filters / maps
  // --------------------------------------------------
  ...
  static const String wishItemEntry = '/wishItemEntry';
  static const String itemSoldOutProductListLegacy =
      '/itemSoldOutProductListLegacy';

  // --------------------------------------------------
  // User / detail / safety / swap / etc.
  // --------------------------------------------------
  static const String userDetail = '/userDetail';
  static const String safetyTips = '/safetyTips';
  static const String addSwapOffer = '/AddSwapOfferScreen';

  // --------------------------------------------------
  // Chat
  // --------------------------------------------------
  static const String chatListScreen = '/chatListScreen';
  static const String cahtListView = '/chatListView'; // legacy typo — keep
  ...
  // --------------------------------------------------
  // NEW — Notification deep-link routes
  // --------------------------------------------------

  /// طلبات التبديل الواردة — ReceivedSwapRequestsScreen
  static const String receivedSwapRequests = '/received_swap_requests';

  /// طلبات التبديل المرسلة — SentSwapRequestsScreen
  static const String sentSwapRequests = '/sent_swap_requests';

  /// تفاصيل طلب تبديل — RequestDetailsScreen
  /// (موجود بالفعل لكن بدون path ثابت — الـ router بيبنيه من RequestDetailsIntentHolder)
  static const String requestDetails = '/requestDetails';

  /// طلبات المتابعة المعلّقة — FollowRequestsScreen
