...
class SellerChatHistoryListProvider extends PsProvider {
  ...
  Future<List<ChatHistory>> getSentList() async {
    final List<ChatHistory> sentList = <ChatHistory>[];

    String url =  '${PsConfig.ps_app_url}rest/chat_items/get_buyer_seller_list/api_key/${PsConfig.ps_api_key}';
    log('inside -> $url');
    ...
    // _chatHistoryList = PsResource(PsStatus.SUCCESS, '', sentList);
    // notifyListeners();
    return sentList;
  }
}
