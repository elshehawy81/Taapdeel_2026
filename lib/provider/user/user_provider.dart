...
import 'package:taapdeel/viewobject/holder/apple_login_parameter_holder.dart';
import 'package:taapdeel/viewobject/holder/google_login_parameter_holder.dart';
import 'package:taapdeel/viewobject/holder/user_login_parameter_holder.dart';
import 'package:taapdeel/viewobject/holder/user_parameter_holder.dart';
import 'package:taapdeel/viewobject/holder/user_register_parameter_holder.dart';
...
class UserProvider extends PsProvider {
  ...
  Future<dynamic> postUserRegister(
      Map<dynamic, dynamic> jsonMap, BuildContext context) async {
    isLoading = true;
      ...
      if (await Utils.checkInternetConnectivity()) {
        ...
        if (firebaseUser != null) {
          ...
          final PsResource<User>? resourceUser =
              await _submitLoginWithAppleId(firebaseUser, context);
  ...
  Future<PsResource<User>?> _submitLoginWithAppleId(
      fb_auth.User user, BuildContext context) async {
    ...
    if (user != null) {
      ...
      final PsResource<User> _apiStatus =
          await postAppleLogin(appleLoginParameterHolder.toMap(), context);
    ...
    if (isCheckBoxSelect) {
      ...
      if (await Utils.checkInternetConnectivity()) {
        ...
        if (firebaseUser != null) {
          ...
          ///
          final PsResource<User>? resourceUser =
              await _submitLoginWithGoogleId(firebaseUser, context);
  ...
  Future<PsResource<User>?> _submitLoginWithGoogleId(
    ...
    if (user != null) {
      ...
      final PsResource<User> _apiStatus =
          await postGoogleLogin(googleLoginParameterHolder.toMap(), context);
  ...
  Future<void> loginWithEmailId(BuildContext context, String email,
    ...
    if (await Utils.checkInternetConnectivity()) {
      ...
      ///
      final PsResource<User> resourceUser =
          await _submitLoginWithEmailId(email, password, context);
  ...
  Future<PsResource<User>> _submitLoginWithEmailId(
    ...
    final PsResource<User> _apiStatus =
        await postUserLogin(userLoginParameterHolder.toMap(), context);
  ...
  Future<PsResource<User>> _submitSignUpWithEmailId(
    ...
    final PsResource<User> _apiStatus =
        await postUserRegister(userRegisterParameterHolder.toMap(), context);
