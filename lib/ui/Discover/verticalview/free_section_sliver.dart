...
class FreeSectionSliver extends StatelessWidget {
  const FreeSectionSliver({
    Key? key,
    required this.title,
    required this.url,
    required this.catId,
...
class _SilverBackgroundSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color silverLight = const Color(0xFFF5F7FA);
    final Color silverMid   = const Color(0xFF2FB5A3);
    final Color silverDark  = const Color(0xFF4B5563);
