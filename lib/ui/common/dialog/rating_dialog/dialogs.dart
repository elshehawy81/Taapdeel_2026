...
/// The standard Rate my app dialog.
class RateMyAppDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      content: contentBuilder(context, defaultContent),
...
class RateMyAppStarDialog extends StatefulWidget {
  ...
  /// The rating changed callback / actions builder.
  ...
  /// Default actions when no [actionsBuilder] is provided.
...
class RateMyAppStarDialogState extends State<RateMyAppStarDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      content: widget.contentBuilder(context, defaultContent),
