          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                // ✅ النص لازم يبقى Flexible/Expanded عشان يقطع بدل ما يعمل overflow
                Expanded(
                  child: Text(
                    widget.titleText, // 👈 أنصح تشيل toUpperCase خصوصاً للعربي
                    overflow: TextOverflow.ellipsis,
                    maxLines: 1,
                    softWrap: false,
                    style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                      color: widget.titleText == Utils.getString(context, 'edit_profile__title') ||
                          widget.titleText == Utils.getString(context, 'Reset') ||
