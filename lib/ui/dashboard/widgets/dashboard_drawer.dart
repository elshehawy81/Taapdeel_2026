...
class DashboardDrawer extends StatelessWidget {
            ...
            return ListView(
              ...
              children: <Widget>[
                ...
                _DrawerMenuWidget(
                  ...
                  onTap:  (t, i) { Navigator.pop(context); onSelectIndex('', i); },
                ),
                if (loggedIn) ...[
                  _DrawerMenuWidget(
                  ...
                  _LogoutTile(
                    onTap: () async {
                      // مهم: لا تستخدم context الخاص بالـ Drawer بعد إغلاقه.
                      // نأخذ rootContext ثابت من الـ Navigator الرئيسي قبل Navigator.pop.
  ...
  Future<void> _doLogout(
    ...
    try {
      ...
      // لذلك لازم يتنفذ قبل pushNamedAndRemoveUntil؛ لأن التنقل بـ removeUntil
      // يزيل HomeView من الشجرة، وبعدها أي setState داخله يسبب صفحة بيضاء / crash.
      onLogoutSuccess();

      if (forceLogin && context.mounted) {
