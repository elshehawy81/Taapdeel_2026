              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  _FadeSlide(
                    anim: _titleAnim,
                    dy: 20,
                    child: _Headline2(compact: compact),
                  ),
                  SizedBox(height: compact ? 5 : 7),
                  _FadeSlide(
                    anim: _subAnim,
                    dy: 14,
                    child: _Subtitle2(compact: compact),
                  ),
...
class _Headline2 extends StatelessWidget {
  const _Headline2({required this.compact});
...
class _Subtitle2 extends StatelessWidget {
  const _Subtitle2({required this.compact});
  ...
  Widget build(BuildContext context) {
    return Text(
      'اختر اللي نفسك فيه بخطوات بسيطة وبأمان ',
      textAlign: TextAlign.start,
      style: TextStyle(
        fontFamily: _C.font,
        color: _C.deepNavy.withOpacity(0.72),
