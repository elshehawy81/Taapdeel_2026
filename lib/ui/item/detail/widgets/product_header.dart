              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      'اختار الثيم اللي تحبة وشارك كارت المنتج',
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(
                ...
                if (data.addedUserId != '' &&
                  ...
                  GestureDetector(
                          ...
                          context,
                            ...
                            if (_apiStatus.data != null) {
                              ...
                              if (widget.itemDetail.itemDetail.data != null) {
                                if (widget.itemDetail.itemDetail.data!.isFavourited ==
                                    PsConst.ONE) {
                                  icon = Container(
                                    padding: const EdgeInsets.only(
                                      top: PsDimens.space8,
                    ...
                    child: (widget.itemDetail.itemDetail.data != null)
                        ? widget.itemDetail.itemDetail.data!.isFavourited == PsConst.ZERO
                        ? icon = Container(
                      padding: const EdgeInsets.only(
                        top: PsDimens.space8,
                        left: PsDimens.space8,
