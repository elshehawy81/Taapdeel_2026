...
class _ItemEntryViewBaseState extends State<ItemEntryViewBase>
  ...
  Future<void> _dismissUploadDialog() async {
    ...
    final BuildContext? dialogContext = _uploadDialogContext;
    ...
    dynamic updateImages(
      ...
      setState(() {
        ...
        if (index == -1) {
          ...
          for (int i = 0;
          i < resultList.length &&
              indexToStart < widget.maxImageCount;
          i++, indexToStart++) {
                                  ...
                                  return Column(
                                    children: <Widget>[
                                      AllControllerTextWidget(
                                        ...
                                        onItemUploaded: widget.onItemUploaded == null
                                            ? null
                                            : (String itemId) => widget.onItemUploaded!(itemId),
                                      ),
                                    ],
                                  );
                                },
