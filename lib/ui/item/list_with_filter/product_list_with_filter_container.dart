                                  ...
                                  children: <Widget>[
                                    if (provider.productList.data != null &&
                                      ...
                                      Container(
                                              ...
                                              SliverGrid(
                                                ...
                                                delegate: SliverChildBuilderDelegate(
                                                    ...
                                                    return TaapdeelProductCardItem(
                                                      ...
                                                      selectedFav: false,
                                                      onTapFav: () {
                                                        // TODO favourite toggle لو هتوصله هنا
                                                      },
                                                    );
                                                  },
                                        ...
                                        provider.productList.status != PsStatus.SUCCESS)
                                      Align(
                                        child: Container(
                                          child: Column(
                                              ...
                                              sliver: SliverGrid(
                                                ...
                                                delegate: SliverChildBuilderDelegate(
                                                    ...
                                                    final List<User> list =
                                                        provider.searchUserList.data ?? <User>[];
                                                    if (list.isEmpty) return const SizedBox.shrink();
                                                      ...
                                                      onFollowBtnTap: () async {
                                                        if (await Utils.checkInternetConnectivity()) {
                                                          Utils.navigateOnUserVerificationView(
                                                            ...
                                                            context,
                                                                () async {
                                                              if (list[index].isFollowed == PsConst.ZERO) {
                                                                setState(() {
                                                                  list[index].isFollowed = PsConst.ONE;
                                                                });

                                                                final UserFollowHolder userFollowHolder = UserFollowHolder(
                                                                  userId: Utils.checkUserLoginId(valueHolder!),
                                                                  followedUserId: list[index].userId,
                                                                );
                                                  ...
                                                  childCount: (provider.searchUserList.data ?? <User>[]).length,
                                                ),
                                              ),
                                            ),
                                          ],
