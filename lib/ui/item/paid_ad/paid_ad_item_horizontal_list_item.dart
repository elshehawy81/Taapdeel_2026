                              ...
                              Container(
                                ...
                                child: Text('(${paidAdItem.item!.conditionOfItem!.name})',
                                    ...
                                    style: Theme.of(context)
                                        ...
                                        .bodyMedium!
                                        .copyWith(
                                        color: PsColors.black, fontSize: 10)),
                          ...
                          children: <Widget>[
                            Flexible(
                              child: Text(
                                ...
                                overflow: TextOverflow.ellipsis,
                                style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white), maxLines: 1, ), ),
