    ...
    if (offer?.item != null) {
      return Row(
        ...
        children: <Widget>[
          ...
          SvgPicture.asset(
            'assets/images/ic_request_swap.svg',
          ),
          const SizedBox(
            width: PsDimens.space6,
          ),
          ClipRRect(
            ...
            child: Container(
              ...
              child: PsNetworkImage(
                ...
                imageAspectRation: PsConst.Aspect_Ratio_1x,
                photoKey: '',
                defaultPhoto: offer!.buyerItem?.defaultPhoto,
                boxfit: BoxFit.cover,
              ),
            ),
          ),
            ...
            child: Column(
              ...
              //  _spacingWidget,
                Row(
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        Text(
                          offer!.buyerItem!.title!.length > 20 ?
                          offer!.buyerItem!.title!.substring(0,20)  + '...':
                          offer!.buyerItem!.title!,
                          overflow: TextOverflow.ellipsis,
                    ...
                    if (offer!.item!.isSoldOut == '1')
                      Visibility(
                        ...
                        maintainAnimation: true,
                        maintainState: true,
                        visible: offer!.buyerItem!.isSoldOut == '1',
                        child: Container(
                          padding: const EdgeInsets.all(PsDimens.space4),
                          decoration: BoxDecoration(
                            color: Colors.grey,
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text(
                      '${offer!.buyerItem!.conditionOfItem!.name}',
                      overflow: TextOverflow.ellipsis,
                      style: Theme.of(context)
                          .textTheme
                          .bodySmall!
               ...
               // _spacingWidget,
                Row(
                  ...
                  children: <Widget>[
                    Text(
                      offer!.buyerItem != null  && offer!.buyerItem!.price != ''
                          ? '${offer!.buyerItem!.itemCurrency!.currencySymbol}  ${Utils.getPriceFormat(offer!.item!.price!, valueHolder.priceFormat!)}'
