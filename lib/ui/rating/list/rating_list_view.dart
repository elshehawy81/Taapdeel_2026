...
import 'package:taapdeel/provider/rating/rating_list_provider.dart';
...
import 'package:taapdeel/ui/common/base/ps_widget_with_appbar_with_two_provider.dart';
...
import 'package:taapdeel/viewobject/holder/rating_list_holder.dart';
...
class _RatingListViewState extends State<RatingListView>
  ...
  late RatingListProvider ratingProvider;
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBarWithTwoProvider<RatingListProvider, UserProvider>(
        ...
        initProvider1: () {
          ...
          return ratingProvider; // non-null
        },
        ...
        initProvider2: () {
          ...
          return userProvider; // non-null
        },
        onProviderReady2: (UserProvider provider) {
          provider.userParameterHolder.loginUserId =
              provider.psValueHolder!.loginUserId;
          provider.userParameterHolder.id = widget.itemUserId;
        ...
        child: Consumer<RatingListProvider>(
          builder: (BuildContext context, RatingListProvider ratingProvider,
              Widget? child) {
            return Stack(
              children: <Widget>[
                Container(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Text(
                          '${userProvider.user.data!.ratingDetail!.totalRatingValue} '
                              '${Utils.getString(context, 'rating_list__out_of_five_stars')}',
                        ),
                      ],
                    ),
                    _RatingWidget(
                      ...
                      value: double.parse(userProvider
                          .user.data!.ratingDetail!.fiveStarCount!),
                      percentage:
                      '${userProvider.user.data!.ratingDetail!.fiveStarPercent} '
                          '${Utils.getString(context, 'rating_list__percent')}',
                    ),
                    _RatingWidget(
                      starCount:
                      Utils.getString(context, 'rating_list__four_star'),
                      value: double.parse(userProvider
                          .user.data!.ratingDetail!.fourStarCount!),
                      percentage:
                      '${userProvider.user.data!.ratingDetail!.fourStarPercent} '
                          '${Utils.getString(context, 'rating_list__percent')}',
                    ),
                    _RatingWidget(
                      starCount:
                      ...
                      percentage:
                      '${userProvider.user.data!.ratingDetail!.threeStarPercent} '
                          '${Utils.getString(context, 'rating_list__percent')}',
                    ),
                    _RatingWidget(
                      starCount:
                      ...
                      value: double.parse(userProvider
                          .user.data!.ratingDetail!.twoStarCount!),
                      percentage:
                      '${userProvider.user.data!.ratingDetail!.twoStarPercent} '
                          '${Utils.getString(context, 'rating_list__percent')}',
                    ),
                    _RatingWidget(
                      starCount:
                      ...
                      value: double.parse(userProvider
                          .user.data!.ratingDetail!.oneStarCount!),
                      percentage:
                      '${userProvider.user.data!.ratingDetail!.oneStarPercent} '
                          '${Utils.getString(context, 'rating_list__percent')}',
                    ),
                    _spacingWidget,
                    const Divider(
