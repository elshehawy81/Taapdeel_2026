...
import 'package:taapdeel/ui/search/search_location_township/search_location_township_list_view_item.dart';
                            ...
                            child: SearchLocationTownshipListViewItem(
                              ...
                              onTap: () {
                                if (index == 0) {
                                  ...
                                  _provider.replaceItemLocationTownshipData(
                                      provider.itemLocationTownshipList.data![index - 1].id!,
                                      provider.itemLocationTownshipList.data![index - 1].cityId!,
                                      provider.itemLocationTownshipList.data![index - 1].townshipName!,
                                      provider.itemLocationTownshipList.data![index - 1].lat!,
                                      provider.itemLocationTownshipList.data![index - 1].lng!);
                                  //Navigator.pop(context, provider.itemLocationTownshipList.data![index - 1]);
