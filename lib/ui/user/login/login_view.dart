...
class _LoginViewState extends State<LoginView> {
  ...
  Future<void> syncPendingFollowsAfterLogin(
    ...
    for (final MapEntry<String, PendingFollowSelection> entry in pending.entries) {
      final String id = entry.key.trim();
      final PendingFollowSelection selection = entry.value;
      final int relationId = selection.relationType;
