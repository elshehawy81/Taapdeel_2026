...
ProductParameterHolder getRecentParameterHome() {
    searchTerm = '';
   // catId = '';
    subCatId = '';
    itemTypeId = '';
  ...
  ProductParameterHolder getTrending() {
    searchTerm = '';
    // catId = '';
    // subCatId = '';
    itemTypeId = '';
  ...
  ProductParameterHolder getFavouriteParameterHolder() {
    searchTerm = '';
    catId = '';
    subCatId = '';
    itemTypeId = '';
    ...
    addedUserId = '';
    isPaid = '';
    orderBy = PsConst.FILTERING_FAVOURITE;
    orderType = PsConst.FILTERING__DESC;
    status = '1';
    isDiscount = '';
    adType = '';
