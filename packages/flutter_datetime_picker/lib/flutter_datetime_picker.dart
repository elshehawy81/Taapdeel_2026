...
import 'src/datetime_picker_theme.dart' as date_time_picker_theme;
//import 'package:flutter_datetime_picker_plus/src/date_model.dart';
//import 'package:flutter_datetime_picker_plus/src/datetime_picker_theme.dart' as date_time_picker_theme;
...
class DatePicker {
  ...
  static Future<DateTime?> showDatePicker(
    ...
    DateTime? currentTime,
        date_time_picker_theme.DatePickerTheme? theme,
  }) async {
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    // ignore: unnecessary_this
        ...
        // ignore: unnecessary_this
        this.theme = theme ?? const date_time_picker_theme.DatePickerTheme(),
  ...
  final date_time_picker_theme.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    final date_time_picker_theme.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(date_time_picker_theme.DatePickerTheme theme) {
  ...
  Widget _renderItemView(date_time_picker_theme.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(date_time_picker_theme.DatePickerTheme theme) {
